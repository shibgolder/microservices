 ...
 *
 * @see TemplateAttributeDefinitionData
 * @author Shib Golder
 */

public class TemplateAttributeValueData {
	private String key;
	private String value;

	public TemplateAttributeValueData() {
		//
	}

	public TemplateAttributeValueData(final String key, final String value) {
		this.key = key;
		this.value = value;
	}
