...
/**
 * A {@link com.sap.cloud.yaas.rammler.commons.builder.ResourceBuilder} for the <code>/{tenant}/all/tagvalues</code> resource.
 * 
 ...
 * 
 */
public class TenantAllTagvaluesBuilder
    extends AbstractResourceBuilder<TenantAllTagvaluesBuilder>
{
     ...
     * 
     */
    public final static String RELATIVE_URI = "/{tenant}/all/tagvalues";
    /**
    ...
    /**
     * Creates a new instance of the {@link TenantAllTagvaluesBuilder}, using the given {@link WebTarget} and {@link RequestParams}.
     * <p>
     * This constructor is not intended for general use. To obtain an instance of {@link TenantAllTagvaluesBuilder} use a
     ...
     * 
     */
    public TenantAllTagvaluesBuilder(WebTarget webTarget, RequestParams requestParams, boolean appendRelativeUri) {
        super(webTarget, requestParams, (appendRelativeUri?RELATIVE_URI:null));
    }

    @Override
    protected TenantAllTagvaluesBuilder makeACopy(RequestParams newRequestParams) {
        return new TenantAllTagvaluesBuilder(getTarget(), newRequestParams, false);
    }
     ...
     * 
     */
    public TenantAllTagvaluesBuilder fillTenant(final String tenant) {
        return this.withUriParam(TenantAllTagvaluesBuilder.URI_PARAM_TENANT, tenant);
    }
     ...
     * 
     */
    public TenantAllTagvaluesBuilder.GetActionBuilder prepareGet() {
        return new TenantAllTagvaluesBuilder.GetActionBuilder(getTarget(), getRequestParams());
    }
     ...
     * 
     */
    public TenantAllTagvaluesBuilder.AnyActionBuilder prepareAny() {
        return new TenantAllTagvaluesBuilder.AnyActionBuilder(getTarget(), getRequestParams());
    }
    ...
    public static class AnyActionBuilder
        extends TenantAllTagvaluesBuilder.ArbitraryActionBuilder<TenantAllTagvaluesBuilder.AnyActionBuilder>
        implements ActionWithPayloadBuilder<TenantAllTagvaluesBuilder.AnyActionBuilder, Object> , HttpActionSettable<TenantAllTagvaluesBuilder.AnyActionBuilder>
    {
        ...
        @Override
        protected TenantAllTagvaluesBuilder.AnyActionBuilder makeACopy(RequestParams newRequestParams) {
            final TenantAllTagvaluesBuilder.AnyActionBuilder actionBuilder = new TenantAllTagvaluesBuilder.AnyActionBuilder(getTarget(), newRequestParams);
        ...
        @Override
        public TenantAllTagvaluesBuilder.AnyActionBuilder withPayload(Entity<?> payload) {
            return this.withRequestPayload(payload);
        }

        @Override
        public TenantAllTagvaluesBuilder.AnyActionBuilder withPayload(Object payload) {
            return this.withRequestPayload(payload);
        }

        @Override
        public TenantAllTagvaluesBuilder.AnyActionBuilder withPayload(Object payload, String mediaType) {
            return this.withRequestPayload(payload, mediaType);
        }

        @Override
        public TenantAllTagvaluesBuilder.AnyActionBuilder fillMethod(com.sap.cloud.yaas.rammler.commons.builder.ActionBuilder.HttpMethod theMethod) {
            final TenantAllTagvaluesBuilder.AnyActionBuilder actionBuilder = makeACopy(this.getRequestParams().makeACopy());
     ...
     * 
     */
    public static abstract class ArbitraryActionBuilder<T extends TenantAllTagvaluesBuilder.ArbitraryActionBuilder<?> >
    ...
    public static class GetActionBuilder
        extends TenantAllTagvaluesBuilder.ArbitraryActionBuilder<TenantAllTagvaluesBuilder.GetActionBuilder>
    {
        ...
        @Override
        protected TenantAllTagvaluesBuilder.GetActionBuilder makeACopy(RequestParams newRequestParams) {
            final TenantAllTagvaluesBuilder.GetActionBuilder actionBuilder = new TenantAllTagvaluesBuilder.GetActionBuilder(getTarget(), newRequestParams);
            actionBuilder.setHttpMethod(this.getHttpMethod());
            actionBuilder.setRequestPayload(this.getRequestPayload());
            return actionBuilder;
        }
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder withAuthorization(String authorization) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder withPageNumber(Integer pageNumber) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder withPageSize(Integer pageSize) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder onNotFound(ResponseCallback callback) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder onServiceUnavailable(ResponseCallback callback) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder onUnauthorized(ResponseCallback callback) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder onForbidden(ResponseCallback callback) {
         ...
         * 
         */
        public TenantAllTagvaluesBuilder.GetActionBuilder onBadRequest(ResponseCallback callback) {
