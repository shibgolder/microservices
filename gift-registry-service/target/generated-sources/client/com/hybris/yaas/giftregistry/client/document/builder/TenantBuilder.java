...
package com.hybris.yaas.giftregistry.client.document.builder;
    ...
    extends AbstractResourceBuilder<TenantBuilder>
{
        ...
        extends TenantBuilder.ArbitraryActionBuilder<TenantBuilder.GetActionBuilder>
    {
         ...
         * 
         */
        public TenantBuilder.GetActionBuilder onNotFound(ResponseCallback callback) {
        ...
        extends TenantBuilder.ArbitraryActionBuilder<TenantBuilder.HeadActionBuilder>
    {
         ...
         * 
         */
        public TenantBuilder.HeadActionBuilder onNotFound(ResponseCallback callback) {
            return this.withCallbackForCode(404, callback);
        }
